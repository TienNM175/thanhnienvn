...
const traits = [
  { id: 0, label: "Trí tuệ & Công nghệ", shapeLevel: 0.9, type: "buff", tag: "Ưu thế cốt lõi", color: "text-cyan-400", bg: "bg-cyan-500/10", border: "border-cyan-500/30", icon: BrainCircuit, image: "https://images.unsplash.com/photo-1531482615713-2afd69097998?auto=format&fit=crop&q=80&w=1000", description: "Tiếp thu cực nhanh tri thức mới, làm chủ công nghệ lõi (AI, Cloud, Blockchain) và đi đầu trong công cuộc chuyển đổi số quốc gia." },
  { id: 1, label: "Năng động & Khát vọng", shapeLevel: 0.95, type: "buff", tag: "Động lực chính", color: "text-amber-400", bg: "bg-amber-500/10", border: "border-amber-500/30", icon: Target, image: "https://images.unsplash.com/photo-1522202176988-66273c2fd55f?auto=format&fit=crop&q=80&w=1000", description: "Dám nghĩ dám làm, khát khao khởi nghiệp mạnh mẽ và luôn có ý thức xây dựng thương hiệu cá nhân trong kỷ nguyên số." },
  ...
  { id: 3, label: "Trách nhiệm Xã hội", shapeLevel: 0.85, type: "buff", tag: "Nền tảng đạo đức", color: "text-green-400", bg: "bg-green-500/10", border: "border-green-500/30", icon: Zap, image: "https://images.unsplash.com/photo-1593113514676-5927dce10a74?auto=format&fit=crop&q=80&w=1000", description: "Tinh thần tình nguyện cao, nhạy bén với các vấn đề môi trường, thiên tai. Sẵn sàng dùng chuyên môn để giải quyết bài toán xã hội." },
  { id: 4, label: "Sức đề kháng Văn hóa", shapeLevel: 0.6, type: "debuff", tag: "Rủi ro tiềm ẩn", color: "text-red-400", bg: "bg-red-500/10", border: "border-red-500/30", icon: ShieldAlert, image: "https://images.unsplash.com/photo-1614064641913-6b8364377bb4?auto=format&fit=crop&q=80&w=1000", description: "Dễ bị tổn thương, thao túng tâm lý bởi thông tin độc hại (Fake news) trên không gian mạng và đối mặt với sự lai căng văn hóa." },
  { id: 5, label: "Áp lực Cạnh tranh", shapeLevel: 0.95, type: "debuff", tag: "Thách thức lớn", color: "text-purple-400", bg: "bg-purple-500/10", border: "border-purple-500/30", icon: Target, image: "https://images.unsplash.com/photo-1498622205843-c15bc5cdd314?auto=format&fit=crop&q=80&w=1000", description: "Chịu sức ép khổng lồ từ nguy cơ AI thay thế việc làm, hội chứng FOMO và áp lực đồng trang lứa (Peer pressure) chưa từng có." },
];
